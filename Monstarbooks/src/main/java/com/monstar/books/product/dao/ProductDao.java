...
//	public ArrayList<BookDto> list(); //상품목록 호출 페이징 전
...
//	public ArrayList<BookDto> searchNoType(String searchKeyword, int rowStart, int rowEnd); //검색조건 없이 검색 후 리스트 호출
	...
	public BookDto detail(int bookno); //상품상세 진입
	...
	public void insertBook(long bisbn, String btitle, String bsubtitle, 
			...
			int bprice, int bpricesell, int bdiscount, String bstatus, int bstock); //상품등록 - M_BOOK 테이블
	public void insertBookDetail(int bcategoryno, String bimg, String bimgdetail, 
			String bdescription, int bpage, String bsize, String badge); //상품등록 - M_BOOK_DETAIL 테이블
	...
	public void updateBook(int bookno, long bisbn, String btitle, String bsubtitle, String bpublisher,
			...
			int bdiscount, String bstatus, int bstock); //상품수정 - M_BOOK 테이블
//	public void updateBookDetail(int bookno, int bcategoryno, String bimg, String bimgdetail, 
//			String bdescription, int bpage, String bsize, String badge); //상품수정 - M_BOOK_DETAIL 테이블
	public void updateBookDetail(int bookno, int bcategoryno,  
			String bdescription, int bpage, String bsize, String badge); //상품수정 - M_BOOK_DETAIL 테이블(이미지 분리)
	public void updateBookDetailImg(int bookno, String bimg, String bimgdetail); //상품수정 - M_BOOK_DETAIL 테이블(이미지 분리)
	
	
	public void deleteBook(int bookno); //상품삭제 - M_BOOK 테이블
	public void deleteBookDetail(int bookno); //상품삭제 - M_BOOK_DETAIL 테이블
